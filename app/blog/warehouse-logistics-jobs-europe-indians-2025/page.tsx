        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Warehouse workers earn €2,000-€4,500 monthly with overtime pay, bonuses, and excellent benefits.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
                  <span className="font-semibold">€2,500 - €4,200</span>
                </div>
                <div className="flex justify-between">
                  <span>Language:</span>
                  <span className="font-semibold">English + Local</span>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  ...
                  <span className="text-blue-600 font-bold">€2,000 - €3,200</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Forklift Operator</span>
                  <span className="text-blue-600 font-bold">€2,200 - €3,800</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Inventory Controller</span>
                  <span className="text-blue-600 font-bold">€2,500 - €4,000</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Delivery Driver</span>
                  <span className="text-blue-600 font-bold">€2,000 - €3,500</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Logistics Coordinator</span>
                  <span className="text-blue-600 font-bold">€2,800 - €4,500</span>
                </div>
              </div>
            </div>
