...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to construction jobs in Germany for Indians. Work permits, visa process, salary, living costs, and career opportunities. Get expert guidance from Ribriz Overseas.',
  keywords: [
    'construction jobs Germany for Indians',
    'work permit Germany for Indians',
    'Germany work visa for Indians',
    'construction jobs Germany salary',
  ...
  openGraph: {
    title: 'Construction Jobs in Germany for Indians 2025: Complete Guide',
    description: 'Complete guide to construction jobs in Germany for Indians. Work permits, visa process, salary, living costs, and career opportunities.',
    images: ['https://images.pexels.com/photos/1591055/pexels-photo-1591055.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'],
  },
}

export default function ConstructionJobsGermany() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-r from-yellow-900 via-orange-800 to-red-800 overflow-hidden">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Construction Jobs in Germany for Indians
                <span className="block text-yellow-300">2025 Complete Guide</span>
              </h1>
              <p className="text-xl text-yellow-100 mb-8 leading-relaxed">
                Discover high-paying construction opportunities, excellent work-life balance, and career growth in Germany. 
                Get expert guidance to make your German construction career dream a reality.
              </p>
            ...
            <div className="relative">
              <Image
                src="https://images.pexels.com/photos/1591055/pexels-photo-1591055.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="German Construction Industry"
                width={600}
                height={400}
      ...
      {/* Why Germany for Construction */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Why Germany is Perfect for Indian Construction Workers
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Germany offers exceptional opportunities for Indian construction professionals with its booming infrastructure sector
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Booming Construction Sector</h3>
              <p className="text-gray-600">
                Germany has a massive construction industry with ongoing infrastructure projects, housing developments, and commercial buildings.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">High Wages</h3>
              <p className="text-gray-600">
                Construction workers earn €2,500-€4,500 monthly with overtime pay, bonuses, and excellent benefits.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Germany faces a critical shortage of skilled construction workers, creating excellent job opportunities for Indians.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                World-class safety standards and modern equipment ensure a safe working environment for all construction workers.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Many construction companies provide accommodation and meals, reducing living costs for workers.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Opportunities to learn new construction techniques, use modern equipment, and gain valuable international experience.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Top Construction Job Categories */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Top Construction Job Categories in Germany
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              High-demand construction roles offering excellent career opportunities and competitive salaries
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Carpenter</h3>
                  <p className="text-yellow-600 font-semibold">Very High Demand</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Skilled carpenters are in high demand for residential and commercial construction projects.
              </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Electrician</h3>
                  <p className="text-blue-600 font-semibold">High Demand</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Licensed electricians are needed for electrical installations, maintenance, and repairs.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Electrical License</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Plumber</h3>
                  <p className="text-green-600 font-semibold">High Demand</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Skilled plumbers are needed for plumbing installations, repairs, and maintenance work.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
                ...
                <div className="flex justify-between">
                  <span>Requirements:</span>
                  <span className="font-semibold">Plumbing License</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Mason/Bricklayer</h3>
                  <p className="text-purple-600 font-semibold">Very High Demand</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Masons and bricklayers are in high demand for building construction and renovation projects.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
                  <span className="font-semibold">€2,400 - €3,800</span>
                </div>
                <div className="flex justify-between">
                  <span>Language:</span>
                  <span className="font-semibold">German A2+</span>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Welder</h3>
                  <p className="text-red-600 font-semibold">High Demand</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Skilled welders are needed for metal fabrication, structural welding, and repair work.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
                  <span className="font-semibold">€2,700 - €4,300</span>
                </div>
                <div className="flex justify-between">
                  <span>Language:</span>
                  <span className="font-semibold">German A2+</span>
                ...
                <div className="flex justify-between">
                  <span>Requirements:</span>
                  <span className="font-semibold">Welding Certification</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900">Construction Supervisor</h3>
                  <p className="text-teal-600 font-semibold">Leadership Role</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Construction supervisors with experience in project management are highly valued.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Salary Range:</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Salary & Benefits in Germany Construction
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Competitive salaries and excellent benefits package for Indian construction workers
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Average Construction Salaries (Monthly)</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">General Laborer</span>
                  <span className="text-yellow-600 font-bold">€2,200 - €3,000</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Skilled Worker</span>
                  <span className="text-yellow-600 font-bold">€2,500 - €4,000</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Licensed Tradesman</span>
                  <span className="text-yellow-600 font-bold">€2,800 - €4,500</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Foreman</span>
                  <span className="text-yellow-600 font-bold">€3,200 - €5,000</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white rounded-xl">
                  <span className="font-semibold">Site Supervisor</span>
                  <span className="text-yellow-600 font-bold">€3,500 - €5,500</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center p-4 bg-white rounded-xl">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Work site transportation provided</div>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white rounded-xl">
                  <span className="text-2xl mr-4">🛡️</span>
                  <div>
                    ...
                    <div className="text-sm text-gray-600">All safety gear and tools provided</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Germany Work Visa Process for Construction Workers
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Step-by-step guide to obtaining your Germany work permit for construction jobs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Secure a job offer from a German construction company who will sponsor your work permit
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Arrival & Registration</h3>
              <p className="text-gray-600 text-sm">
                Register at local authorities and start working with your approved work permit
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about life in Germany as an Indian construction worker
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Many companies provide accommodation or housing allowance to reduce living costs.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Many construction companies provide lunch, and groceries are affordable.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Excellent public transport system, and many companies provide work transportation.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                World-class healthcare system with mandatory health insurance for all workers.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-50 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Many companies provide German language classes to help workers integrate better.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
      ...
      {/* CTA Section */}
      <section id="contact" className="py-16 bg-gradient-to-r from-yellow-900 via-orange-800 to-red-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Ready to Start Your Germany Construction Career Journey?
          </h2>
          <p className="text-xl text-yellow-100 mb-8 max-w-3xl mx-auto">
            Join thousands of successful Indian construction workers who achieved their German career dreams with Ribriz Overseas. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl">
              ...
              <div className="text-yellow-200">Construction Workers Placed</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl">
